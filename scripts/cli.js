...
const contractABI = require("../artifacts/contracts/Poweramptorch.sol/Poweramptorch.json").abi;

program
    .name("poweramptorch-cli")
    .description("CLI tool for Poweramptorch smart contract")
    .version("1.0.0");
