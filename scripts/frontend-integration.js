 ...
 * This file demonstrates how to integrate Poweramptorch with a web frontend
 */

// For React/Vue/Angular applications
export class PoweramptorchClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PoweramptorchClient(provider, contractAddress);
